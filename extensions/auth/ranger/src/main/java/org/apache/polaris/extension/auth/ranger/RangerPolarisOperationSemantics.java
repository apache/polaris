...
public record RangerPolarisOperationSemantics(
  ...
  static {
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RangerPolarisOperationSemantics(
            EnumSet.of(NAMESPACE_LIST), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.CREATE_NAMESPACE,
        new RangerPolarisOperationSemantics(
            EnumSet.of(NAMESPACE_CREATE), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RangerPolarisOperationSemantics(
            EnumSet.of(NAMESPACE_DROP), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RangerPolarisOperationSemantics(
            EnumSet.of(TABLE_LIST), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.CREATE_TABLE_DIRECT,
        new RangerPolarisOperationSemantics(
            EnumSet.of(TABLE_CREATE), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RangerPolarisOperationSemantics(
            EnumSet.of(TABLE_READ_DATA), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.LOAD_TABLE_WITH_WRITE_DELEGATION,
        new RangerPolarisOperationSemantics(
            EnumSet.of(TABLE_WRITE_DATA), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RangerPolarisOperationSemantics(
            EnumSet.of(TABLE_DROP), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RangerPolarisOperationSemantics(EnumSet.of(VIEW_LIST), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.CREATE_VIEW,
        new RangerPolarisOperationSemantics(
            EnumSet.of(VIEW_CREATE), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RangerPolarisOperationSemantics(EnumSet.of(VIEW_DROP), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RangerPolarisOperationSemantics(
            EnumSet.of(CATALOG_LIST), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.CREATE_CATALOG,
        new RangerPolarisOperationSemantics(
            EnumSet.of(CATALOG_CREATE), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RangerPolarisOperationSemantics(
            EnumSet.of(CATALOG_DROP), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.LIST_PRINCIPALS,
        new RangerPolarisOperationSemantics(
            EnumSet.of(PRINCIPAL_LIST), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.CREATE_PRINCIPAL,
        new RangerPolarisOperationSemantics(
            EnumSet.of(PRINCIPAL_CREATE), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RangerPolarisOperationSemantics(
            EnumSet.of(PRINCIPAL_DROP), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RangerPolarisOperationSemantics(
            EnumSet.of(CATALOG_ROLE_LIST), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RangerPolarisOperationSemantics(
            EnumSet.of(CATALOG_ROLE_DROP), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RangerPolarisOperationSemantics(
            EnumSet.of(POLICY_CREATE), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.LOAD_POLICY,
        new RangerPolarisOperationSemantics(
            EnumSet.of(POLICY_READ), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.DROP_POLICY,
        new RangerPolarisOperationSemantics(
            EnumSet.of(POLICY_DROP), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.UPDATE_POLICY,
        new RangerPolarisOperationSemantics(
            EnumSet.of(POLICY_WRITE), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.LIST_POLICY,
        new RangerPolarisOperationSemantics(
            EnumSet.of(POLICY_LIST), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RangerPolarisOperationSemantics(
            EnumSet.of(TABLE_ASSIGN_UUID), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RangerPolarisOperationSemantics(
            EnumSet.of(TABLE_ADD_SCHEMA), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RangerPolarisOperationSemantics(
            EnumSet.of(TABLE_ADD_SNAPSHOT), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RangerPolarisOperationSemantics(
            EnumSet.of(TABLE_SET_LOCATION), null, ResolvedPathRooting.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
  ...
  static RangerPolarisOperationSemantics forOperation(PolarisAuthorizableOperation operation) {
    RangerPolarisOperationSemantics semantics = RBAC_SEMANTICS_BY_OPERATION.get(operation);
    if (semantics == null) {

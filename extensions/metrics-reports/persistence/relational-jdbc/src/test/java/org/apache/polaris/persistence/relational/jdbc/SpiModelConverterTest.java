...
class SpiModelConverterTest {
  ...
  void scanRoundTrip() {
    ...
    assertThat(restored.reportId()).isEqualTo(original.reportId());
    assertThat(restored.catalogId()).isEqualTo(original.catalogId());
    assertThat(restored.tableId()).isEqualTo(original.tableId());
  ...
  void nullOptionalFields() {
    ScanMetricsRecord record = minimalScanRecord();
    ModelScanMetricsReport model = ModelScanMetricsReport.fromRecord(record, TEST_REALM_ID);
  ...
  private ScanMetricsRecord minimalScanRecord() {
    return ScanMetricsRecord.builder()
        .reportId(TEST_REPORT_ID)
        .catalogId(TEST_CATALOG_ID)
        .tableId(TEST_TABLE_ID)

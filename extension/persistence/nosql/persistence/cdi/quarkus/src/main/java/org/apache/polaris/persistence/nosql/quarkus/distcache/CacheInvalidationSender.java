...
import static org.apache.polaris.persistence.nosql.quarkus.distcache.QuarkusCacheInvalidationsConfig.CACHE_INVALIDATIONS_CONFIG_PREFIX;
import static org.apache.polaris.persistence.nosql.quarkus.distcache.QuarkusCacheInvalidationsConfig.CONFIG_SERVICE_NAMES;
import static org.apache.polaris.persistence.nosql.quarkus.distcache.QuarkusCacheInvalidationsConfig.CONFIG_VALID_TOKENS;
...
class CacheInvalidationSender implements DistributedCacheInvalidation.Sender {
  ...
  CacheInvalidationSender(
      ...
      QuarkusCacheInvalidationsConfig config,

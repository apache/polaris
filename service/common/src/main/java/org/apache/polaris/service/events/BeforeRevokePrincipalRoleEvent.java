 ...
 */
public class BeforeRevokePrincipalRoleEvent {
     ...
     */
    public BeforeRevokePrincipalRoleEvent(String principalName, String principalRoleName, String requestId, AuthenticatedPolarisPrincipal principal) {

 ...
 */
public class AfterListCatalogRolesForPrincipalRoleEvent {
     ...
     */
    public AfterListCatalogRolesForPrincipalRoleEvent(String principalRoleName, String catalogName, String requestId, AuthenticatedPolarisPrincipal principal) {

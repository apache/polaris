...
public class BeforeListGrantsForCatalogRoleEvent {
    ...
    /**
     * Constructs a new BeforeListGrantsForCatalogRoleEvent.
     *
     ...
     */
    public BeforeListGrantsForCatalogRoleEvent(String catalogName, String catalogRoleName, String requestId, AuthenticatedPolarisPrincipal principal) {

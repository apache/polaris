 ...
 */
public class BeforePrincipalUpdateEvent {
     ...
     */
    public BeforePrincipalUpdateEvent(String principalName, UpdatePrincipalRequest updateRequest, String requestId, AuthenticatedPolarisPrincipal principal) {

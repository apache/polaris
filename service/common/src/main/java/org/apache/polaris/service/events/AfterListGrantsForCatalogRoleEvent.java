 ...
 */
public class AfterListGrantsForCatalogRoleEvent implements PolarisEvent {
    ...
    /**
     * Constructs a new AfterListGrantsForCatalogRoleEvent.
     *
     ...
     */
    public AfterListGrantsForCatalogRoleEvent(String catalogName, String catalogRoleName, String requestId, AuthenticatedPolarisPrincipal principal) {

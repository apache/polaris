...
public class AfterRevokeGrantFromCatalogRoleEvent implements PolarisEvent {
     ...
     */
    public AfterRevokeGrantFromCatalogRoleEvent(String catalogName, String catalogRoleName, PolarisPrivilege privilege, RevokeGrantRequest grantRequest, Boolean cascade, String requestId, AuthenticatedPolarisPrincipal principal) {

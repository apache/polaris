 ...
 */
public record BeforeCatalogRoleRevokeFromPrincipalRoleEvent(String eventId, String principalRoleName, String catalogName, String catalogRoleName) implements PolarisEvent {}

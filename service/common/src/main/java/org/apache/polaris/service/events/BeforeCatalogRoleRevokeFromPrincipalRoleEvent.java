 ...
 */
public class BeforeCatalogRoleRevokeFromPrincipalRoleEvent implements PolarisEvent {
    ...
    /**
     * Constructs a new BeforeCatalogRoleRevokeFromPrincipalRoleEvent.
     *
     ...
     */
    public BeforeCatalogRoleRevokeFromPrincipalRoleEvent(String principalRoleName, String catalogName, String catalogRoleName, String requestId, AuthenticatedPolarisPrincipal principal) {

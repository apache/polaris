 ...
 */
public class BeforeCatalogRoleGetEvent {
     ...
     */
    public BeforeCatalogRoleGetEvent(String catalogName, String catalogRoleName, String requestId, AuthenticatedPolarisPrincipal principal) {

...
public interface IcebergCatalogPrefixParser {
   ...
   * specified realm.
   *
   * @param realmId identifies the realm where the API request is to be served.
   * @param prefix the "prefix" according to the Iceberg REST Catalog API specification.
   * @return Polaris Catalog name
   */
  String prefixToCatalogName(RealmId realmId, String prefix);
   ...
   *
   * @param realmId identifies the realm owning the catalog
   ...
   */
  String catalogNameToPrefix(RealmId realmId, String catalogName);
}

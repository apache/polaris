 ...
 */
public class BeforePrincipalRoleGetEvent {
     ...
     */
    public BeforePrincipalRoleGetEvent(String principalRoleName, String requestId, AuthenticatedPolarisPrincipal principal) {

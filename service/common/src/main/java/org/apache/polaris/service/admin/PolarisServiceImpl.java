...
public class PolarisServiceImpl
  ...
  private PolarisAdminService newAdminService(Realm realm, SecurityContext securityContext) {
  ...
  public Response createCatalog(
      CreateCatalogRequest request, Realm realm, SecurityContext securityContext) {
    PolarisAdminService adminService = newAdminService(realm, securityContext);
    Catalog catalog = request.getCatalog();
    validateStorageConfig(catalog.getStorageConfigInfo(), realm);
    Catalog newCatalog =
  ...
  private void validateStorageConfig(StorageConfigInfo storageConfigInfo, Realm realm) {
    List<String> allowedStorageTypes =
        configurationStore.getConfiguration(
            realm, PolarisConfiguration.SUPPORTED_CATALOG_STORAGE_TYPES);
  ...
  /** From PolarisCatalogsApiService */
  @Override
  public Response deleteCatalog(String catalogName, Realm realm, SecurityContext securityContext) {
    PolarisAdminService adminService = newAdminService(realm, securityContext);
  ...
  /** From PolarisCatalogsApiService */
  @Override
  public Response getCatalog(String catalogName, Realm realm, SecurityContext securityContext) {
    PolarisAdminService adminService = newAdminService(realm, securityContext);
  ...
  public Response updateCatalog(
    ...
    if (updateRequest.getStorageConfigInfo() != null) {
      validateStorageConfig(updateRequest.getStorageConfigInfo(), realm);
    }
  ...
  /** From PolarisCatalogsApiService */
  @Override
  public Response listCatalogs(Realm realm, SecurityContext securityContext) {
    PolarisAdminService adminService = newAdminService(realm, securityContext);
  ...
  public Response createPrincipal(
      CreatePrincipalRequest request, Realm realm, SecurityContext securityContext) {
    PolarisAdminService adminService = newAdminService(realm, securityContext);
  ...
  public Response deletePrincipal(
      String principalName, Realm realm, SecurityContext securityContext) {
    PolarisAdminService adminService = newAdminService(realm, securityContext);
  ...
  /** From PolarisPrincipalsApiService */
  @Override
  public Response getPrincipal(String principalName, Realm realm, SecurityContext securityContext) {
    PolarisAdminService adminService = newAdminService(realm, securityContext);
  ...
  /** From PolarisPrincipalsApiService */
  @Override
  public Response listPrincipals(Realm realm, SecurityContext securityContext) {
    PolarisAdminService adminService = newAdminService(realm, securityContext);
  ...
  public Response createPrincipalRole(
      CreatePrincipalRoleRequest request, Realm realm, SecurityContext securityContext) {
    PolarisAdminService adminService = newAdminService(realm, securityContext);
  ...
  public Response deletePrincipalRole(
      String principalRoleName, Realm realm, SecurityContext securityContext) {
    PolarisAdminService adminService = newAdminService(realm, securityContext);
  ...
  /** From PolarisPrincipalRolesApiService */
  @Override
  public Response listPrincipalRoles(Realm realm, SecurityContext securityContext) {
    PolarisAdminService adminService = newAdminService(realm, securityContext);
  ...
  public Response deleteCatalogRole(
      String catalogName, String catalogRoleName, Realm realm, SecurityContext securityContext) {
    PolarisAdminService adminService = newAdminService(realm, securityContext);
  ...
  public Response listCatalogRoles(
      String catalogName, Realm realm, SecurityContext securityContext) {
    PolarisAdminService adminService = newAdminService(realm, securityContext);
  ...
  public Response listCatalogRolesForPrincipalRole(
      String principalRoleName, String catalogName, Realm realm, SecurityContext securityContext) {
    PolarisAdminService adminService = newAdminService(realm, securityContext);
    List<CatalogRole> catalogRoleList =

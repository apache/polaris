...
/**
 * Event fired before the list of catalog roles for a principal role is retrieved in Polaris.
 */
public class BeforeListCatalogRolesForPrincipalRoleEvent implements PolarisEvent {
    ...
    /**
     * Constructs a new BeforeListCatalogRolesForPrincipalRoleEvent.
     *
     ...
     */
    public BeforeListCatalogRolesForPrincipalRoleEvent(String principalRoleName, String catalogName, String requestId, AuthenticatedPolarisPrincipal principal) {

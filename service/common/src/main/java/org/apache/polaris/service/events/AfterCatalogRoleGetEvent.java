 ...
 */
public class AfterCatalogRoleGetEvent {
     ...
     */
    public AfterCatalogRoleGetEvent(String catalogName, String catalogRoleName, String requestId, AuthenticatedPolarisPrincipal principal) {

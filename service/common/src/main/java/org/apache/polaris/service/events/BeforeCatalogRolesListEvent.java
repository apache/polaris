 ...
 */
public class BeforeCatalogRolesListEvent implements PolarisEvent {
    private final String catalogName;
    private final String requestId;
    private final AuthenticatedPolarisPrincipal principal;

    /**
     * Constructs a new BeforeCatalogRolesListEvent.
     *
     * @param catalogName the name of the catalog
     * @param requestId   the request ID for this operation
     * @param principal   the authenticated principal performing the operation
     */
    public BeforeCatalogRolesListEvent(String catalogName, String requestId, AuthenticatedPolarisPrincipal principal) {

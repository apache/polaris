...
class TableCleanupTaskHandlerTest {
  ...
  public void testTableCleanup() throws IOException {
    ...
    assertThat(
            metaStoreManagerFactory
                ...
                .loadTasks(callContext.getPolarisCallContext(), "test", PageRequest.fromLimit(2))
                .getEntities())
        .hasSize(2)
  ...
  public void testTableCleanupHandlesAlreadyDeletedMetadata() throws IOException {
    ...
    assertThat(
            metaStoreManagerFactory
                .getOrCreateMetaStoreManager(realmContext)
                .loadTasks(callContext.getPolarisCallContext(), "test", PageRequest.fromLimit(5))
                .getEntities())
        .hasSize(2);
  }
  ...
  public void testTableCleanupMultipleMetadata() throws IOException {
    ...
    List<PolarisBaseEntity> entities =
        metaStoreManagerFactory
            ...
            .loadTasks(callContext.getPolarisCallContext(), "test", PageRequest.fromLimit(6))
            .getEntities();

 ...
 * under the License.
 */
package org.apache.polaris.service.quarkus.distcache;
...
import org.apache.polaris.service.quarkus.catalog.AbstractIcebergCatalogTest;
  ...
  public static class Profile extends AbstractIcebergCatalogTest.Profile {
    ...
    public Map<String, String> getConfigOverrides() {
      return ImmutableMap.<String, String>builder()
          ...
          .put("polaris.persistence.type", "persistence")
          .put("polaris.backend.name", "InMemory")
          .put("polaris.persistence.cache-invalidations.valid-tokens", "token1," + TOKEN)
          .put("polaris.persistence.cache-invalidations.service-names", "=127.0.0.1,=127.1.2.3")
          .build();
    }
  }

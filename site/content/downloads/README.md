...
menus:
  main:
    ...
    identifier: releases-[version]  # Unique identifier, e.g.: releases-1.3.0, releases-1.2.0, etc.
---
```
...
The releases sidebar automatically categorizes releases into "Active Releases" and "EOL Releases"

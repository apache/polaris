...
export QUARKUS_DATASOURCE_POSTGRESQL_JDBC_URL=$(printf '%s' "jdbc:postgresql://$POSTGRES_ADDR/POLARIS")
export QUARKUS_DATASOURCE_POSTGRESQL_USERNAME=postgres
export QUARKUS_DATASOURCE_POSTGRESQL_PASSWORD="$POSTGRES_PASSWORD"
echo $QUARKUS_DATASOURCE_POSTGRESQL_JDBC_URL

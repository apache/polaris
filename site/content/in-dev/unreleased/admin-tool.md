...
- One standalone JAR in `runtime/admin/build/polaris-runtime-admin-*-runner.jar`
...
```shell
java -jar runtime/admin/build/polaris-runtime-admin-*-runner.jar --help
```
...
```
Usage: polaris-runtime-admin-runner.jar [-hV] [COMMAND]
Polaris Admin Tool
...
```shell
java -jar runtime/admin/build/polaris-runtime-admin-*-runner.jar bootstrap --help
```

The basic usage of the `bootstrap` command is outlined below:

```
Usage: polaris-runtime-admin-runner.jar bootstrap [-hV] [-c=<realm,clientId,
...
```shell
java -jar runtime/admin/build/polaris-runtime-admin-*-runner.jar bootstrap -r realm1 -c realm1,admin,admin
```
...
```shell
java -jar runtime/admin/build/polaris-runtime-admin-*-runner.jar purge --help
```

The basic usage of the `purge` command is outlined below:

```
Usage: polaris-runtime-admin-runner.jar purge [-hV] -r=<realm> [-r=<realm>]...
...
```shell
java -jar runtime/admin/build/polaris-runtime-admin-*-runner.jar purge -r realm1
```
...
- One standalone JAR in `quarkus/admin/build/polaris-admin-*-runner.jar`
...
```shell
java -jar quarkus/admin/build/polaris-admin-*-runner.jar --help
```
...
```shell
java -jar quarkus/admin/build/polaris-admin-*-runner.jar bootstrap --help
```
...
```shell
java -jar quarkus/admin/build/polaris-admin-*-runner.jar bootstrap -r realm1 -c realm1,admin,admin
```
...
```shell
java -jar quarkus/admin/build/polaris-admin-*-runner.jar purge --help
```
...
```shell
java -jar quarkus/admin/build/polaris-admin-*-runner.jar purge -r realm1
```
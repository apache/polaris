...
| hostUsers | bool | `nil` | Specifies whether a pod should use the host's user namespace. See [User Namespaces](https://kubernetes.io/docs/concepts/workloads/pods/user-namespaces/). |

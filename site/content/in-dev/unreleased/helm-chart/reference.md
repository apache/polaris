...
| httproute.managementPathPrefix | string | `"/mgmt"` | Configure where the management endpoints are exposed. The default is /mgmt, which means that the management endpoints will be exposed on the /mgmt path of the HTTPRoute. |

...
Command Options:
  ...
  --property PROPERTY                                                  A key/value pair such as: tag=value. Multiple can be provided by specifying this option more than once. Catalog properties are client-visible defaults and must not contain passwords, tokens, access keys, or other secrets.

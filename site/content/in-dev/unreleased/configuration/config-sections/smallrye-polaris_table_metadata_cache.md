...
Configuration for the process-wide cache of table metadata JSON documents, keyed by metadata file location.  Metadata files are immutable, so cached entries never go stale.

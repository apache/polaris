...
{{< alert note >}}
For Production tips and best practices, refer to [Configuring Polaris for Production]({{% ref "configuring-polaris-for-production" %}}).
{{< /alert >}}
...
For a comprehensive reference of all Polaris configuration options, see the [Configuration Reference]({{% ref "configuration-reference.md" %}}) page.
...
There are many other actionable environment variables available in the official Polaris Docker image:

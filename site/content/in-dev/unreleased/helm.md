...
| managementService.ports[0].targetPort | string | `nil` | Number of the port to access on the pods targeted by the service. If this is not specified, the value of the 'port' field is used. |
...
| service.ports[0].targetPort | string | `nil` | Number of the port to access on the pods targeted by the service. If this is not specified, the value of the 'port' field is used. |

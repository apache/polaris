...
```
svn mv https://dist.apache.org/repos/dist/dev/incubator/polaris/helm-chart/index.yaml \
  https://dist.apache.org/repos/dist/dev/incubator/polaris/helm-chart/artifacthub-repo.yml \

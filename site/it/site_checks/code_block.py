...
docker_compose_up_args = "--detach --wait"
...
class CodeBlockBase:
    ...
    def __init__(self, line_no: int, start_marker: str, code_type: Optional[str] = None):
...
class CodeBlock(CodeBlockBase):
    ...
    def __init__(self, line_no: int, start_marker: str, code_type: Optional[str] = None):
        super().__init__(line_no, start_marker, code_type)
        self.nested_code_blocks = []


# noinspection SpellCheckingInspection
def emit_code_block(f: TextIOBase, type_name: str, code: List[str], line_no: int) -> None:
    """
    ...
    """
    f.write(f'echo "::group::Dump of {type_name} code block at line {line_no}"\n')

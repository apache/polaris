...
2. Start the docker compose group by running the following command from the root of the repository:
    ...
    ```shell
    docker compose -f getting-started/jdbc/docker-compose-postgres.yml -f getting-started/jdbc/docker-compose-bootstrap-db.yml -f getting-started/jdbc/docker-compose.yml up
    ```

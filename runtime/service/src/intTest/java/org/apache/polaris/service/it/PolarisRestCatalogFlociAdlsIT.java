...
@QuarkusTestResource(
    ...
    initArgs = {
      @ResourceArg(name = "storageContainer", value = "floci-az-test-polaris"),
      @ResourceArg(name = "account", value = "polarisfloci"),
      @ResourceArg(name = "secret", value = "polaris-floci-azure-secret")
    })
@ExtendWith(PolarisIntegrationTestExtension.class)
public class PolarisRestCatalogFlociAdlsIT {
  ...
  @FlociAzure static FlociAzureAccess flociAzureAccess;
  ...
  void before(TestInfo testInfo) {
    var principalName = client.newEntityName("floci-adls-user");
    var principalRoleName = client.newEntityName("floci-adls-admin");
  ...
  void createsTableAndWritesData() throws IOException {
    try (var restCatalog = restCatalog()) {
      ...
      var fileContent = "Hello Floci ADLS".getBytes(UTF_8);

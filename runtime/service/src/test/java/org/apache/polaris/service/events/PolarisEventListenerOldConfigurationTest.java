...
public class PolarisEventListenerOldConfigurationTest {
  ...
  public void testOldListenerConfig() {
    ...
    assertTrue(polarisEventListenerConfiguration.types().isPresent());
    assertEquals("test", polarisEventListenerConfiguration.type().get());
    assertEquals(Set.of("test"), polarisEventListenerConfiguration.types().get());
  }
}

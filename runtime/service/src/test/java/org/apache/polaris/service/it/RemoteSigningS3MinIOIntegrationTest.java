...
@QuarkusTest
@TestProfile(RemoteSigningS3MinIOIntegrationTest.Profile.class)
@ExtendWith(MinioExtension.class)
@ExtendWith(PolarisIntegrationTestExtension.class)
public class RemoteSigningS3MinIOIntegrationTest extends PolarisRemoteSigningS3IntegrationTestBase {

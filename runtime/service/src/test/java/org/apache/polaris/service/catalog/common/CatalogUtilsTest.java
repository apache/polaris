...
class CatalogUtilsTest {
  ...
  private ResolvedPolarisEntity rns1;
  private ResolvedPolarisEntity rns2;
  private ResolvedPolarisEntity rt3;
  ...
  void initMocks() {
    ...
    resolutionManifestFactory =
        (p, catalogName) ->
            new PolarisResolutionManifest(diagnostics, null, resolverFactory, p, catalogName);
  }
  ...
  void testFailedLocationSiblingResolutionException() {
    ...
    Assertions.assertThatThrownBy(
            () ->
                CatalogUtils.resolveOptionalPaths(
                    resolutionManifestFactory, principal, List.of(), "test"))
  ...
  void testLocationSiblingResolution() {
    ...
    List<PolarisEntity> entities =
        CatalogUtils.resolveOptionalPaths(
            resolutionManifestFactory, principal, List.of(k1, k2, k3, k4), "test");

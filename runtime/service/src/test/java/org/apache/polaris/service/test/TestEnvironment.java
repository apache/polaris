 ...
 *
 * @param baseUri The base URL that requests should target, for example {@code
 *     http://localhost:8181}
 * @param baseManagementUri The base URL that requests should target for the management interface,
 *     for example {@code http://localhost:8182}
 ...
 */
public record TestEnvironment(URI baseUri, URI baseManagementUri, String testId) {

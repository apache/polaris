...
public class S3RemoteSigningMinIOIntegrationTest extends PolarisS3RemoteSigningIntegrationTest {
  ...
  public static class Profile implements QuarkusTestProfile {
    ...
    public Map<String, String> getConfigOverrides() {
      return ImmutableMap.<String, String>builder()
          // Polaris will use these keys for remote signing
          ...
          // Required for MinIO because Polaris needs subscoped credentials
          // in order to get the right endpoint URL to use when writing metadata files.
          // FIXME
  ...
  public void testLoadTableWithAccessDelegationForExternalCatalogWithConfigEnabledForCatalog() {
    System.out.println();
    super.testLoadTableWithAccessDelegationForExternalCatalogWithConfigEnabledForCatalog();
  }
}

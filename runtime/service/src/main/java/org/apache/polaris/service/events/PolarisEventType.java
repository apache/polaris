...
public enum PolarisEventType {
  ...
  // Directory Events
  BEFORE_CREATE_DIRECTORY(1600, Category.DIRECTORY),
  AFTER_CREATE_DIRECTORY(1601, Category.DIRECTORY),
  BEFORE_DROP_DIRECTORY(1602, Category.DIRECTORY),
  AFTER_DROP_DIRECTORY(1603, Category.DIRECTORY),
  BEFORE_LIST_DIRECTORIES(1604, Category.DIRECTORY),
  AFTER_LIST_DIRECTORIES(1605, Category.DIRECTORY),
  BEFORE_LOAD_DIRECTORY(1606, Category.DIRECTORY),
  AFTER_LOAD_DIRECTORY(1607, Category.DIRECTORY);

...
public interface OidcTenantConfiguration {
  ...
  interface PrincipalMapper {
     ...
     * inside the "client1" object inside the "resource_access" object in the token claims.
     *
     * <p>Optional when using internal credential mode, in which case either this option or {@link
     * #idClaimPath()} must be provided.
     *
     * <p>Required when using external credential mode ({@code
     ...
     * org.apache.polaris.service.auth.external.mapping.PrincipalMapper} identifier.
     */
    @WithDefault("default")
    String type();
  }
  ...
  interface PrincipalRolesMapper {
     ...
     * org.apache.polaris.service.auth.external.mapping.PrincipalRolesMapper} identifier.
     */
    @WithDefault("default")
    String type();

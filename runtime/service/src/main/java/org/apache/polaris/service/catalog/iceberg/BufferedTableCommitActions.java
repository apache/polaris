...
/** Buffers table-commit actions until a multi-table transaction can apply them atomically. */
final class BufferedTableCommitActions implements TableCommitActions {

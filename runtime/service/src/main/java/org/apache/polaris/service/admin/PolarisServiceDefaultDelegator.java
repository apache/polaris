...
public class PolarisServiceDefaultDelegator implements PolarisCatalogsApiService, PolarisPrincipalsApiService, PolarisPrincipalRolesApiService {
    private final PolarisServiceImpl delegate;

    @Inject
    public PolarisServiceDefaultDelegator(@ApiBusinessLogic PolarisServiceImpl polarisService) {
    ...
    public Response updatePrincipalRole(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.updatePrincipalRole(principalRoleName, updateRequest, realmContext, securityContext);
    }
    ...
    public Response updateCatalogRole(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.updateCatalogRole(catalogName, catalogRoleName, updateRequest, realmContext, securityContext);
    }
    ...
    public Response revokePrincipalRole(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.revokePrincipalRole(principalName, principalRoleName, realmContext, securityContext);
    }
    ...
    public Response assignCatalogRoleToPrincipalRole(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.assignCatalogRoleToPrincipalRole(principalRoleName, catalogName, request, realmContext, securityContext);
    }
    ...
    public Response revokeCatalogRoleFromPrincipalRole(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.revokeCatalogRoleFromPrincipalRole(principalRoleName, catalogName, catalogRoleName, realmContext, securityContext);
    }
    ...
    public Response listAssigneePrincipalsForPrincipalRole(
            String principalRoleName, RealmContext realmContext, SecurityContext securityContext) {
        return delegate.listAssigneePrincipalsForPrincipalRole(principalRoleName, realmContext, securityContext);
    }
    ...
    public Response listCatalogRolesForPrincipalRole(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.listCatalogRolesForPrincipalRole(principalRoleName, catalogName, realmContext, securityContext);
    }
    ...
    public Response addGrantToCatalogRole(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.addGrantToCatalogRole(catalogName, catalogRoleName, grantRequest, realmContext, securityContext);
    }
    ...
    public Response revokeGrantFromCatalogRole(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.revokeGrantFromCatalogRole(catalogName, catalogRoleName, cascade, grantRequest, realmContext, securityContext);
    }
    ...
    public Response listAssigneePrincipalRolesForCatalogRole(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.listAssigneePrincipalRolesForCatalogRole(catalogName, catalogRoleName, realmContext, securityContext);
    }
    ...
    public Response listGrantsForCatalogRole(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.listGrantsForCatalogRole(catalogName, catalogRoleName, realmContext, securityContext);
    }
}

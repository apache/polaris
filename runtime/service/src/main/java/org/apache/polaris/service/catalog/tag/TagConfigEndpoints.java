...
public class TagConfigEndpoints implements CatalogConfigEndpointContributor {
  ...
  @Inject
  public TagConfigEndpoints(RealmConfig realmConfig, PolarisMetaStoreManager metaStoreManager) {
  ...
  public Set<Endpoint> endpoints() {
    return metaStoreManager.supportsEntityType(PolarisEntityType.TAG)
        ? getSupportedTagEndpoints(realmConfig)
        : ImmutableSet.of();
  }

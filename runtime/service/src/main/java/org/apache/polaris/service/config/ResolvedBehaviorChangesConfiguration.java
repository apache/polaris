...
/**
 * Wraps around {@link BehaviorChangesConfiguration} but removes properties from `defaults` that
 * shouldn't be there
 */
@ApplicationScoped
@Alternative
@Priority(1)
public class ResolvedBehaviorChangesConfiguration implements BehaviorChangesConfiguration {

  private final Map<String, String> cleanedDefaults;
  private final Map<String, RealmOverrides> realmOverrides;

  public ResolvedBehaviorChangesConfiguration(RawBehaviorChangesConfiguration raw) {

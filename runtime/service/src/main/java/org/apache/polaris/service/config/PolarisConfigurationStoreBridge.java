...
public class PolarisConfigurationStoreBridge
  ...
  private final DefaultConfigurationStore store;

  @Inject
  public PolarisConfigurationStoreBridge(DefaultConfigurationStore store) {
    this.store = store;
  }
  ...
  public <T> @Nullable T getConfiguration(@Nonnull RealmContext realmContext, String configName) {
    ...
    T value = (T) store.getConfigValue(realmContext, configName);
    return value;
  }
}

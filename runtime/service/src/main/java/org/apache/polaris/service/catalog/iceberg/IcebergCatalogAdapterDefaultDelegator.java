...
public class IcebergCatalogAdapterDefaultDelegator implements IcebergRestCatalogApiService, IcebergRestConfigurationApiService, CatalogAdapter {
    private final IcebergCatalogAdapter delegate;

    @Inject
    public IcebergCatalogAdapterDefaultDelegator(@ApiBusinessLogic IcebergCatalogAdapter catalogAdapter) {
    ...
    public Response listNamespaces(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.listNamespaces(prefix, pageToken, pageSize, parent, realmContext, securityContext);
    }
    ...
    public Response updateProperties(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.updateProperties(prefix, namespace, updateNamespacePropertiesRequest, realmContext, securityContext);
    }
    ...
    public Response createTable(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.createTable(prefix, namespace, createTableRequest, accessDelegationMode, realmContext, securityContext);
    }
    ...
    public Response listTables(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.listTables(prefix, namespace, pageToken, pageSize, realmContext, securityContext);
    }
    ...
    public Response loadTable(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.loadTable(prefix, namespace, table, accessDelegationMode, ifNoneMatchString, snapshots, realmContext, securityContext);
    }
    ...
    public Response dropTable(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.dropTable(prefix, namespace, table, purgeRequested, realmContext, securityContext);
    }
    ...
    public Response registerTable(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.registerTable(prefix, namespace, registerTableRequest, realmContext, securityContext);
    }
    ...
    public Response updateTable(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.updateTable(prefix, namespace, table, commitTableRequest, realmContext, securityContext);
    }
    ...
    public Response listViews(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.listViews(prefix, namespace, pageToken, pageSize, realmContext, securityContext);
    }
    ...
    public Response replaceView(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.replaceView(prefix, namespace, view, commitViewRequest, realmContext, securityContext);
    }
    ...
    public Response reportMetrics(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.reportMetrics(prefix, namespace, table, reportMetricsRequest, realmContext, securityContext);
    }
    ...
    public Response sendNotification(
            ...
            RealmContext realmContext,
            SecurityContext securityContext) {
        return delegate.sendNotification(prefix, namespace, table, notificationRequest, realmContext, securityContext);
    }

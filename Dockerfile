...
WORKDIR /app
COPY --from=build /app/polaris-service/dropwizard/build/docker-dist/bin /app/bin
COPY --from=build /app/polaris-service/dropwizard/build/docker-dist/lib /app/lib

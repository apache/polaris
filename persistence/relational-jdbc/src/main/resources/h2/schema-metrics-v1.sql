...
-- ============================================================================
-- POLARIS METRICS-ONLY SCHEMA (v1) - H2 Database
-- ============================================================================
-- This schema file contains ONLY the metrics tables and is used for
-- deployments where metrics are stored in a separate database from entity data.
--
-- For unified deployments (metrics in same database), use schema-v4.sql instead.
-- ============================================================================

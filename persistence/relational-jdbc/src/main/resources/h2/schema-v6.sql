...
-- Changes from v5:
--  * `idx_locations` already used (realm_id, catalog_id, location_without_scheme) in v5; this
--    version is a no-op bump to keep H2 in sync with the Postgres/CockroachDB schema version
--    sequence. The index was already correct and matches the predicate in

...
-- METRICS TABLES
-- ============================================================================
-- Metrics tables (scan_metrics_report, commit_metrics_report) are defined in
-- a separate schema file: schema-metrics-v1.sql
--
-- This allows metrics to be stored in a separate database when configured.
-- The metrics schema is bootstrapped separately via MetricsSchemaBootstrapUtil.
-- ============================================================================
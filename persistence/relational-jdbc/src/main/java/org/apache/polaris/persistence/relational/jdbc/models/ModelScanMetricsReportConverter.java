...
public class ModelScanMetricsReportConverter implements Converter<ModelScanMetricsReport> {
  ...
  public ModelScanMetricsReport fromResultSet(ResultSet rs) throws SQLException {
    return ImmutableModelScanMetricsReport.builder()
        ...
        .catalogId(rs.getString(ModelScanMetricsReport.CATALOG_ID))
        .catalogName(rs.getString(ModelScanMetricsReport.CATALOG_NAME))
        .namespace(rs.getString(ModelScanMetricsReport.NAMESPACE))
        .tableName(rs.getString(ModelScanMetricsReport.TABLE_NAME_COL))

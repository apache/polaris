...
public class ModelCommitMetricsReportConverter implements Converter<ModelCommitMetricsReport> {
  ...
  public ModelCommitMetricsReport fromResultSet(ResultSet rs) throws SQLException {
    return ImmutableModelCommitMetricsReport.builder()
        ...
        .catalogId(rs.getString(ModelCommitMetricsReport.CATALOG_ID))
        .catalogName(rs.getString(ModelCommitMetricsReport.CATALOG_NAME))
        .namespace(rs.getString(ModelCommitMetricsReport.NAMESPACE))
        .tableName(rs.getString(ModelCommitMetricsReport.TABLE_NAME_COL))

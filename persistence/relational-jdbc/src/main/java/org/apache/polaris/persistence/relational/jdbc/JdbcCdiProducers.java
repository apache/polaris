...
/**
 * CDI producers for JDBC-specific beans. Co-located with the JDBC persistence module so that
 * downstream runtimes only need to include this module to get the default wiring.
 */
public class JdbcCdiProducers {

  /**
   * Produces the active {@link DataSourceResolver} by selecting the bean identified by {@link
   * RelationalJdbcConfiguration#dataSourceResolverType()}.
   *

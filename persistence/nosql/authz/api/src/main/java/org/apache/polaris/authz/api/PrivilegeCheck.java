...
public interface PrivilegeCheck {
   ...
   * privilege check instance}. A privilege is granted, if it is granted to any role in the given
   * ACL or any of its parents. See note on non-inheritable privileges below.
   *

...
@Outcome(
    ...
    desc = "Concurrent shortcut reads do not trigger a load.")
@State
public class LazyIndexImplShortcutStress {
  ...
  public void actor1(ZZI_Result r) {
    r.r1 = FIRST_KEY.equals(index.first());
  }

  @Actor
  public void actor2(ZZI_Result r) {
    r.r2 = index.containsElement(LAST_KEY);
  }

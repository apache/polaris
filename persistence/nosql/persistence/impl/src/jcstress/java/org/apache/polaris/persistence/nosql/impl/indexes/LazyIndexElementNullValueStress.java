...
@Outcome(
    ...
    desc = "Concurrent null probes and value materialization stay consistent.")
@State
public class LazyIndexElementNullValueStress {
  private static final IndexKey EXPECTED_KEY = key("key-c");

  private final InternalIndexElement<ObjRef> element = singleElement(EXPECTED_KEY, null);
  ...
  public void actor2(ZZ_Result r) {
    r.r2 = element.valueNullable() == null;
  }
}

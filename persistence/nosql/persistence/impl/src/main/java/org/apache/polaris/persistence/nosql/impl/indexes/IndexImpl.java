...
final class IndexImpl<V> implements IndexSpi<V> {
   ...
   * deserialization operations, which are very frequent. The JMH results justify the use of a
   * {@link ThreadLocal} in this case.
   *
   * <p>This {@link ThreadLocal} based approach is way better compared to {@link ByteBuffer}s
   * memoized via an {@link java.util.ArrayDeque}. JMH results are as follows. Invoked via {@code
   * java -jar
   ...
   *         <td>1.2</td>
   *         <td>4.5</td>
   *         <td>insn/clk (lower is better)</td>
   *     </tr>
   *     <tr>

 ...
 * necessary to purge a whole realm. Some databases do support "deleting a huge amount of rows".
 ...
 * way. Some database do not support such "prefix-key deletions" at all, for example Apache
 ...
 * does require a two-step approach that works even for large multi-tenant setups:
 *
 * <ol>
 ...
 * org.apache.polaris.realms.api.RealmDefinition#status() status} of the realm to retain and to
 * purge, that the status is valid for being retained (valid: {@linkplain
 * org.apache.polaris.realms.api.RealmDefinition.RealmStatus#ACTIVE ACTIVE} and {@linkplain
 * org.apache.polaris.realms.api.RealmDefinition.RealmStatus#INACTIVE INACTIVE}) and being purged
 * (valid: {@linkplain org.apache.polaris.realms.api.RealmDefinition.RealmStatus#PURGING PURGING}).
 ...
 * org.apache.polaris.realms.api.RealmDefinition.RealmStatus#PURGED PURGED}.
 *

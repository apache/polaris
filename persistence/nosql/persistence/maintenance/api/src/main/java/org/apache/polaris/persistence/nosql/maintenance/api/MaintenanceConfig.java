...
public interface MaintenanceConfig {
   ...
   * started.
   *
   * <p>This value a safety net for two reasons:
   *
   * <ul>
   *   <li>Respect wall-clock drift between Polaris nodes.
  ...
  /**
   * Optionally limit the number of reference scanned per second. Default is to not throttle
   * reference scanning.
   */
  @JsonInclude(JsonInclude.Include.NON_ABSENT)

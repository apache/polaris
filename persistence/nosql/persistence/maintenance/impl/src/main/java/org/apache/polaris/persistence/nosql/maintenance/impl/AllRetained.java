...
final class AllRetained {
  ...
  private final BloomFilter<Map.Entry<String, String>> refsFilter;
  private final BloomFilter<Map.Entry<String, Long>> objsFilter;
  ...
  private void refFunnel(Map.Entry<String, String> realmRef, PrimitiveSink primitiveSink) {
  ...
  private void objFunnel(Map.Entry<String, Long> realmObj, PrimitiveSink primitiveSink) {
    primitiveSink.putInt(salt);

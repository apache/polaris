...
public record UpdateKeyForCatalogAndEntityType(
  ...
  public static UpdateKeyForCatalogAndEntityType updateKeyForCatalogAndEntityType(
    ...
    var mapping = byEntityType(type);
    mapping.checkCatalogId(catalogId);
    var catalogContent = mapping.catalogContent();
    return new UpdateKeyForCatalogAndEntityType(type, catalogId, catalogContent);
  }
}

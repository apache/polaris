 ...
 */
public record SecurableAndGrantee(
  ...
  public static SecurableAndGrantee forTriplet(
      long catalogId, AclObj aclObj, GrantTriplet triplet) {
  ...
  public PolarisGrantRecord grantRecordForPrivilege(int privilegeCode) {

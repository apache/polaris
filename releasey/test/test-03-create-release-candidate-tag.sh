...
DRY_RUN=1 \
  "${releasey_dir}/03-create-release-candidate-tag.sh" \
...
expected_content="git tag apache-polaris-42.41.40-incubating-rc1
git push apache apache-polaris-42.41.40-incubating-rc1
git checkout apache-polaris-42.41.40-incubating-rc1"

...
class ListPoliciesResponse(BaseModel):
    ...
    identifiers: Optional[List[PolicyIdentifier]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "identifiers": [PolicyIdentifier.from_dict(_item) for _item in obj["identifiers"]] if obj.get("identifiers") is not None else None
        })
        return _obj

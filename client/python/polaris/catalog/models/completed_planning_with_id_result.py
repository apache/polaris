...
class CompletedPlanningWithIDResult(BaseModel):
    """
    ...
    status: PlanStatus
    plan_id: Optional[StrictStr] = Field(default=None, description="ID used to track a planning request", alias="plan-id")
    __properties: ClassVar[List[str]] = ["delete-files", "file-scan-tasks", "plan-tasks", "status", "plan-id"]

...
class GetApplicablePoliciesResponse(BaseModel):
    ...
    applicable_policies: List[ApplicablePolicy] = Field(alias="applicable-policies")
    __properties: ClassVar[List[str]] = ["next-page-token", "applicable-policies"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "applicable-policies": [ApplicablePolicy.from_dict(_item) for _item in obj["applicable-policies"]] if obj.get("applicable-policies") is not None else None
        })
        return _obj

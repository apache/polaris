...
class UpdatePolicyRequest(BaseModel):
    ...
    current_policy_version: Optional[StrictInt] = Field(default=None, alias="current-policy-version")
    __properties: ClassVar[List[str]] = ["description", "content", "current-policy-version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "current-policy-version": obj.get("current-policy-version")
        })
        return _obj

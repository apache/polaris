...
class UpdateCatalogRequest(BaseModel):
    ...
    storage_config_info: Optional[StorageConfigInfo] = Field(default=None, alias="storageConfigInfo")
    __properties: ClassVar[List[str]] = ["currentEntityVersion", "properties", "storageConfigInfo"]

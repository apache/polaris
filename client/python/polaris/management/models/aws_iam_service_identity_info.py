...
class AwsIamServiceIdentityInfo(ServiceIdentityInfo):
    """
    AwsIamServiceIdentityInfo
    """ # noqa: E501
    iam_arn: StrictStr = Field(description="The ARN of the IAM user or IAM role Polaris uses to assume roles and then access external resources.", alias="iamArn")

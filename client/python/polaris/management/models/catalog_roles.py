...
class CatalogRoles(BaseModel):
    """
    CatalogRoles
    """ # noqa: E501
    roles: List[CatalogRole] = Field(description="The list of catalog roles")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "roles": [CatalogRole.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None
        })
        return _obj

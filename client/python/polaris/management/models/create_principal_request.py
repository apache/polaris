...
class CreatePrincipalRequest(BaseModel):
    ...
    credential_rotation_required: Optional[StrictBool] = Field(default=None, description="If true, the initial credentials can only be used to call rotateCredentials", alias="credentialRotationRequired")
    __properties: ClassVar[List[str]] = ["principal", "credentialRotationRequired"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credentialRotationRequired": obj.get("credentialRotationRequired")
        })
        return _obj

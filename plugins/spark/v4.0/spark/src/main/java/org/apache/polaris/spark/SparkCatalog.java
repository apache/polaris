...
public class SparkCatalog
  ...
  // This method is required by SupportsReplaceView interface from Iceberg
  // It provides backward compatibility with the old API signature
  @Override
  public View replaceView(
      ...
      throws NoSuchNamespaceException, NoSuchViewException {
    // Delegate to the new API by creating a ViewInfo object
    ViewInfo viewInfo =
        new ViewInfo(
            ident,
            sql,

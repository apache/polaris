...
In the following diagram, a sample [Apache Polaris structure](overview.md#catalog) with nested [namespaces](overview.md#namespace) is shown for Catalog1. No tables

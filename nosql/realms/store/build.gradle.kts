...
description = "Polaris realms persistence"

dependencies {
  implementation(project(":polaris-realms-api"))
  implementation(project(":polaris-realms-spi"))
  ...
  testFixturesRuntimeOnly(project(":polaris-persistence-cdi-weld"))
  testFixturesApi(testFixtures(project(":polaris-persistence-cdi-weld")))

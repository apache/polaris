...
class IdGeneratorProvider {
  ...
  IdGenerator idGenerator(
      Node leasedNode, NodeManagement nodeManagement, MonotonicClock monotonicClock) {
    return nodeManagement.buildIdGenerator(leasedNode, monotonicClock::currentTimeMillis);
  }
}

...
class PersistenceMetaStoreManager implements PolarisMetaStoreManager {
  ...
  public PolicyAttachmentResult attachPolicyToEntity(
    ...
    var ms = ms(callCtx);
    return ms.attachDetachPolicyOnEntity(policy, target, true, parameters);
  }
  ...
  public PolicyAttachmentResult detachPolicyFromEntity(
      ...
      @Nonnull PolicyEntity policy) {
    var ms = ms(callCtx);
    return ms.attachDetachPolicyOnEntity(policy, target, false, Map.of());
  }
  ...
  public LoadPolicyMappingsResult loadPoliciesOnEntity(
    ...
    var ms = ms(callCtx);
    return ms.loadPoliciesOnEntity(target, Optional.empty());
  }
  ...
  public LoadPolicyMappingsResult loadPoliciesOnEntityByType(
    ...
    var ms = ms(callCtx);
    return ms.loadPoliciesOnEntity(target, Optional.of(policyType));
  }

...
import org.apache.polaris.persistence.coretypes.content.GenericTableObj;
...
import org.apache.polaris.persistence.coretypes.content.PolicyObj;
...
class TypeMapping {
  ...
  @Nonnull
  static <O extends ObjBase, B extends ObjBase.Builder<O, B>> B newEntityObjBuilder(
      @Nonnull ObjBase src) {
    @SuppressWarnings("unchecked")
    var builder =
        (B)
            switch (src) {
              case IcebergTableObj ignored -> IcebergTableObj.builder();
              case IcebergViewObj ignored -> IcebergViewObj.builder();
              case LocalNamespaceObj ignored -> LocalNamespaceObj.builder();
              case RemoteNamespaceObj ignored -> RemoteNamespaceObj.builder();
              case PolicyObj ignored -> PolicyObj.builder();
              case CatalogObj ignored -> CatalogObj.builder();
              case CatalogRoleObj ignored -> CatalogRoleObj.builder();
              case RootObj ignored -> RootObj.builder();
              case ImmediateTaskObj ignored -> ImmediateTaskObj.builder();
              case PrincipalObj ignored -> PrincipalObj.builder();
              case PrincipalRoleObj ignored -> PrincipalRoleObj.builder();
              default ->
                  throw new IllegalStateException(
                      "Cannot map "
                          + src.type().targetClass().getSimpleName()
                          + " to a entity type/sub-type");
            };
    return builder.from(src);
  }

 ...
 * under the License.
 */
package org.apache.polaris.persistence.api.commit;
...
public interface UpdateState {
  ...
  /**
   * Add {@code obj} to the list of objects to be persisted, using the given {@code key} to
   * {@linkplain #getWrittenByKey(Object) identify/reuse} an already persisted object in a retried
   * attempt.
   *
  ...
  /**
   * Add {@code obj} to the list of objects to be persisted, using the given {@code key} to
   * {@linkplain #getWrittenByKey(Object) identify/reuse} an already persisted object in retried
   * attempt.
   *
   * <p>Note that objects will not be immediately persisted, but after the {@linkplain
   * CommitRetryable#attempt(CommitterState, Supplier) attempt returns}, but before the {@linkplain

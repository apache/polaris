...
helm-doc-generate: check-dependencies ## Generate Helm chart documentation
	...
	@helm-docs --chart-search-root=helm --template-files helm.md.gotmpl --output-file helm.md
	@$(PYTHON) helm/polaris/tools/prepare_helm_readme.py helm/polaris/helm.md site/content/in-dev/unreleased/helm.md

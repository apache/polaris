...
| persistence.relationalJdbc | object | `{"secret":{"jdbcUrl":null,"name":null,"password":null,"username":null}}` | The configuration for the relational-jdbc persistence manager. |

        ...
        .ifPresent(
            method -> {
              ...
              try (Response response =
                  adminClient.assignCatalogRole(catalogName, "catalog-admin", newRole)) {
                assertThat(response)
                    .returns(Response.Status.CREATED.getStatusCode(), Response::getStatus);
              }
              ...
              try (Response response =
                  adminClient.grantCatalog(catalogName, "admin", grantResource)) {
                assertThat(response)
                    .returns(Response.Status.CREATED.getStatusCode(), Response::getStatus);
              }
              ...
              try (Response response = adminClient.getCatalogRole(catalogName, "admin")) {
                ...
                try (Response ignore = adminClient.createCatalogRole(catalogName, catalogRole)) {
                  assertThat(response)
                      .returns(Response.Status.OK.getStatusCode(), Response::getStatus);
                }
              }

...
def _create_fine_grained_principal(polaris_url, polaris_catalog_url, root_client, catalog):
    ...
    Works with any catalog fixture (file_catalog, s3_catalog, auto_catalog, etc.)
    """
    ...
    try:
        ...
        writer_catalog_role = create_catalog_role(root_client, catalog, catalog_role_name)
        ...
        }, principal_name, principal_role_name, catalog_role_name
...
def test_coarse_grained_table_write_properties(polaris_url, polaris_catalog_url, root_client, file_catalog):
    """Test that coarse-grained TABLE_WRITE_PROPERTIES privilege allows all metadata operations"""
    
    # Create principal for this test
    principal_info, principal_name, principal_role_name, catalog_role_name = _create_fine_grained_principal(
        polaris_url, polaris_catalog_url, root_client, file_catalog
    )
...
def test_fine_grained_table_set_properties(polaris_url, polaris_catalog_url, root_client, file_catalog):
...
def test_fine_grained_table_remove_properties(polaris_url, polaris_catalog_url, root_client, file_catalog):
...
def test_multiple_fine_grained_privileges_together(polaris_url, polaris_catalog_url, root_client, file_catalog):
...
def test_fine_grained_insufficient_permissions(polaris_url, polaris_catalog_url, root_client, file_catalog):

...
public class PolarisEntityConstants {
  ...
  private static final String STORAGE_CONFIGURATION_INFOS_PROPERTY_NAME =
      "storage_configuration_infos";
  ...
  public static String getStorageConfigInfosPropertyName() {
    return STORAGE_CONFIGURATION_INFOS_PROPERTY_NAME;
  }

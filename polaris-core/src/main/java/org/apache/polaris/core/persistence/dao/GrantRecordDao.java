...
/** This will replace the class PolarisGrantManager. */
public interface GrantRecordDao {
   ...
   */
  @Nonnull
  PolarisGrantManager.PrivilegeResult grantUsageOnRoleToGrantee(
   ...
   */
  @Nonnull
  PolarisGrantManager.PrivilegeResult revokeUsageOnRoleFromGrantee(
      @Nonnull PolarisCallContext callCtx,
      @Nullable PolarisEntityCore catalog,
      @Nonnull PolarisEntityCore role,
      @Nonnull PolarisEntityCore grantee);
   ...
   */
  @Nonnull
  PolarisGrantManager.PrivilegeResult revokePrivilegeOnSecurableFromRole(
      @Nonnull PolarisCallContext callCtx,
      @Nonnull PolarisEntityCore grantee,
      @Nullable List<PolarisEntityCore> catalogPath,
      @Nonnull PolarisEntityCore securable,
   ...
   */
  @Nonnull
  default PolarisGrantManager.LoadGrantsResult loadGrantsOnSecurable(
   ...
   */
  @Nonnull
  default PolarisGrantManager.LoadGrantsResult loadGrantsToGrantee(
   ...
   */
  @Nonnull
  PolarisGrantManager.LoadGrantsResult loadGrantsToGrantee(

...
public final class EntityConverter {
    ...
    private static StorageConfigInfo getEntityStorageInfo(Map<String, String> internalProperties, CatalogEntity entity) {
    ...
    private static ConnectionConfigInfo getEntityConnectionInfo(Map<String, String> internalProperties, CatalogEntity entity) {

...
public class EventEntity {
  ...
  /**
   * Identifier of the catalog this event was scoped to, or {@code null} for events that are not
   * catalog-scoped (e.g., principal/realm-level operations).
   */
  @Nullable private final String catalogId;

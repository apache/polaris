...
public record MetaStoreChangeSet(
    ...
    @NonNull List<PolarisBaseEntity> deletes,
  ...
  public static final MetaStoreChangeSet EMPTY =
      new MetaStoreChangeSet(List.of(), List.of(), List.of(), List.of(), List.of());
  ...
  public static MetaStoreChangeSet ofUpdates(@NonNull List<EntityWithPath> updates) {
    return new MetaStoreChangeSet(List.of(), updates, List.of(), List.of(), List.of());
  }
  ...
  public static MetaStoreChangeSet ofBatch(
    ...
    return new MetaStoreChangeSet(creates, updates, List.of(), List.of(), List.of());
  }
  ...
  public static class Builder {
    ...
    private final List<PolarisBaseEntity> deletes = new ArrayList<>();
    ...
    public Builder(MetaStoreChangeSet existing) {
      ...
      this.deletes.addAll(existing.deletes);
    ...
    public Builder addUpdate(
      ...
      // Store original in the entity's internal properties for CAS
      this.updates.add(new EntityWithPath(catalogPath, entity));
      return this;
    }

    public Builder addDelete(@NonNull PolarisBaseEntity entity) {

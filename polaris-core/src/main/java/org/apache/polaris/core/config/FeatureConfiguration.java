      ...
      PolarisConfiguration.<Boolean>builder()
          ...
          .description(
              "If true, the OpenLineage ingest endpoints are enabled and advertised to clients in "
                  ...
                  + "endpoints return 404 Not Found and are not advertised. The routes are always "
                  + "mounted when the OpenLineage extension is assembled into the server; this flag "
                  + "is the runtime switch that turns the feature on or off.")
          .defaultValue(true)
          .buildFeatureConfiguration();

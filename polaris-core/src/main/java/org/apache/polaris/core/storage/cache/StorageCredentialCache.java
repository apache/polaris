...
public class StorageCredentialCache {
  ...
  public StorageAccessConfig getOrGenerateSubScopeCreds(
    ...
    //    session tags (catalog/namespace/table/roles/traceId/requestId)
    ...
    //
    // Note: The trace ID and request ID are controlled at the source (StorageAccessConfigProvider).
    // When INCLUDE_TRACE_ID_IN_SESSION_TAGS / INCLUDE_REQUEST_ID_IN_SESSION_TAGS are disabled,
    // the corresponding fields are left empty, which allows efficient caching across requests.

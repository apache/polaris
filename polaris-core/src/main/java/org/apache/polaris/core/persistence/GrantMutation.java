...
/**
 * Represents a single grant-record mutation (create or delete) as part of an atomic {@link
...
public record GrantMutation(@NonNull PolarisGrantRecord grantRecord, @NonNull MutationType type) {
  ...
  /** Create a new grant-record mutation. */
  ...
  /** Create a delete grant-record mutation. */

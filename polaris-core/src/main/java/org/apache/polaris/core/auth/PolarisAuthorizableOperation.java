...
public enum PolarisAuthorizableOperation {
  ...
  REGISTER_TABLE_WITH_READ_DELEGATION(EnumSet.of(TABLE_CREATE, TABLE_READ_DATA)),
  REGISTER_TABLE_WITH_WRITE_DELEGATION(EnumSet.of(TABLE_CREATE, TABLE_WRITE_DATA)),
  REGISTER_TABLE_OVERWRITE_WITH_READ_DELEGATION(EnumSet.of(TABLE_FULL_METADATA, TABLE_READ_DATA)),
  REGISTER_TABLE_OVERWRITE_WITH_WRITE_DELEGATION(EnumSet.of(TABLE_FULL_METADATA, TABLE_WRITE_DATA)),

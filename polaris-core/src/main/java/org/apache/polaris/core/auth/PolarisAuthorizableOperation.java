...
public enum PolarisAuthorizableOperation {
  ...
  LIST_PRINCIPALS(true, PRINCIPAL_LIST),
  CREATE_PRINCIPAL(true, PRINCIPAL_CREATE),
  GET_PRINCIPAL(true, PRINCIPAL_READ_PROPERTIES),
  UPDATE_PRINCIPAL(true, PRINCIPAL_WRITE_PROPERTIES),
  DELETE_PRINCIPAL(true, PRINCIPAL_DROP),
  ROTATE_CREDENTIALS(true, PRINCIPAL_ROTATE_CREDENTIALS),
  RESET_CREDENTIALS(true, PRINCIPAL_RESET_CREDENTIALS),
  LIST_PRINCIPAL_ROLES_ASSIGNED(true, PRINCIPAL_LIST_GRANTS),
  ASSIGN_PRINCIPAL_ROLE(true, PRINCIPAL_ROLE_MANAGE_GRANTS_ON_SECURABLE),
  REVOKE_PRINCIPAL_ROLE(
      true, PRINCIPAL_ROLE_MANAGE_GRANTS_ON_SECURABLE, PRINCIPAL_MANAGE_GRANTS_FOR_GRANTEE),
  LIST_PRINCIPAL_ROLES(true, PRINCIPAL_ROLE_LIST),
  CREATE_PRINCIPAL_ROLE(true, PRINCIPAL_ROLE_CREATE),
  GET_PRINCIPAL_ROLE(true, PRINCIPAL_ROLE_READ_PROPERTIES),
  UPDATE_PRINCIPAL_ROLE(true, PRINCIPAL_ROLE_WRITE_PROPERTIES),
  DELETE_PRINCIPAL_ROLE(true, PRINCIPAL_ROLE_DROP),
  LIST_ASSIGNEE_PRINCIPALS_FOR_PRINCIPAL_ROLE(true, PRINCIPAL_ROLE_LIST_GRANTS),
  LIST_CATALOG_ROLES_FOR_PRINCIPAL_ROLE(true, PRINCIPAL_ROLE_LIST_GRANTS),
  ASSIGN_CATALOG_ROLE_TO_PRINCIPAL_ROLE(true, CATALOG_ROLE_MANAGE_GRANTS_ON_SECURABLE),
  REVOKE_CATALOG_ROLE_FROM_PRINCIPAL_ROLE(
      true, CATALOG_ROLE_MANAGE_GRANTS_ON_SECURABLE, PRINCIPAL_ROLE_MANAGE_GRANTS_FOR_GRANTEE),
  LIST_CATALOG_ROLES(true, CATALOG_ROLE_LIST),
  CREATE_CATALOG_ROLE(true, CATALOG_ROLE_CREATE),
  GET_CATALOG_ROLE(true, CATALOG_ROLE_READ_PROPERTIES),
  UPDATE_CATALOG_ROLE(true, CATALOG_ROLE_WRITE_PROPERTIES),
  DELETE_CATALOG_ROLE(true, CATALOG_ROLE_DROP),
  LIST_ASSIGNEE_PRINCIPAL_ROLES_FOR_CATALOG_ROLE(true, CATALOG_ROLE_LIST_GRANTS),
  LIST_GRANTS_FOR_CATALOG_ROLE(true, CATALOG_ROLE_LIST_GRANTS),
  ADD_ROOT_GRANT_TO_PRINCIPAL_ROLE(true, SERVICE_MANAGE_ACCESS),
  REVOKE_ROOT_GRANT_FROM_PRINCIPAL_ROLE(
      true, SERVICE_MANAGE_ACCESS, PRINCIPAL_ROLE_MANAGE_GRANTS_FOR_GRANTEE),
  LIST_GRANTS_ON_ROOT(true, SERVICE_MANAGE_ACCESS),
  ADD_PRINCIPAL_GRANT_TO_PRINCIPAL_ROLE(true, PRINCIPAL_MANAGE_GRANTS_ON_SECURABLE),
  REVOKE_PRINCIPAL_GRANT_FROM_PRINCIPAL_ROLE(
      true, PRINCIPAL_MANAGE_GRANTS_ON_SECURABLE, PRINCIPAL_ROLE_MANAGE_GRANTS_FOR_GRANTEE),
  LIST_GRANTS_ON_PRINCIPAL(true, PRINCIPAL_LIST_GRANTS),
  ADD_PRINCIPAL_ROLE_GRANT_TO_PRINCIPAL_ROLE(true, PRINCIPAL_ROLE_MANAGE_GRANTS_ON_SECURABLE),
  REVOKE_PRINCIPAL_ROLE_GRANT_FROM_PRINCIPAL_ROLE(
      true, PRINCIPAL_ROLE_MANAGE_GRANTS_ON_SECURABLE, PRINCIPAL_ROLE_MANAGE_GRANTS_FOR_GRANTEE),
  LIST_GRANTS_ON_PRINCIPAL_ROLE(true, PRINCIPAL_ROLE_LIST_GRANTS),
  ADD_CATALOG_ROLE_GRANT_TO_CATALOG_ROLE(true, CATALOG_ROLE_MANAGE_GRANTS_ON_SECURABLE),
  REVOKE_CATALOG_ROLE_GRANT_FROM_CATALOG_ROLE(
      true, CATALOG_ROLE_MANAGE_GRANTS_ON_SECURABLE, CATALOG_ROLE_MANAGE_GRANTS_FOR_GRANTEE),
  LIST_GRANTS_ON_CATALOG_ROLE(true, CATALOG_ROLE_LIST_GRANTS),
  ADD_CATALOG_GRANT_TO_CATALOG_ROLE(true, CATALOG_MANAGE_GRANTS_ON_SECURABLE),
  REVOKE_CATALOG_GRANT_FROM_CATALOG_ROLE(
      true, CATALOG_MANAGE_GRANTS_ON_SECURABLE, CATALOG_ROLE_MANAGE_GRANTS_FOR_GRANTEE),
  LIST_GRANTS_ON_CATALOG(true, CATALOG_LIST_GRANTS),
  ADD_NAMESPACE_GRANT_TO_CATALOG_ROLE(true, NAMESPACE_MANAGE_GRANTS_ON_SECURABLE),
  REVOKE_NAMESPACE_GRANT_FROM_CATALOG_ROLE(
      true, NAMESPACE_MANAGE_GRANTS_ON_SECURABLE, CATALOG_ROLE_MANAGE_GRANTS_FOR_GRANTEE),
  LIST_GRANTS_ON_NAMESPACE(true, NAMESPACE_LIST_GRANTS),
  ADD_TABLE_GRANT_TO_CATALOG_ROLE(true, TABLE_MANAGE_GRANTS_ON_SECURABLE),
  REVOKE_TABLE_GRANT_FROM_CATALOG_ROLE(
      true, TABLE_MANAGE_GRANTS_ON_SECURABLE, CATALOG_ROLE_MANAGE_GRANTS_FOR_GRANTEE),
  LIST_GRANTS_ON_TABLE(true, TABLE_LIST_GRANTS),
  ADD_VIEW_GRANT_TO_CATALOG_ROLE(true, VIEW_MANAGE_GRANTS_ON_SECURABLE),
  REVOKE_VIEW_GRANT_FROM_CATALOG_ROLE(
      true, VIEW_MANAGE_GRANTS_ON_SECURABLE, CATALOG_ROLE_MANAGE_GRANTS_FOR_GRANTEE),
  LIST_GRANTS_ON_VIEW(true, VIEW_LIST_GRANTS),
  ...
  ADD_POLICY_GRANT_TO_CATALOG_ROLE(true, POLICY_MANAGE_GRANTS_ON_SECURABLE),
  REVOKE_POLICY_GRANT_FROM_CATALOG_ROLE(
      true, POLICY_MANAGE_GRANTS_ON_SECURABLE, CATALOG_ROLE_MANAGE_GRANTS_FOR_GRANTEE),
  ...
  private final boolean rbacAdminOperation;
  ...
  PolarisAuthorizableOperation(PolarisPrivilege targetPrivilege) {
    this(false, targetPrivilege == null ? null : EnumSet.of(targetPrivilege), null);
  }
  ...
  PolarisAuthorizableOperation(EnumSet<PolarisPrivilege> privilegesOnTarget) {
    this(false, privilegesOnTarget, null);
  }
  ...
  PolarisAuthorizableOperation(
    ...
    this(
        false, targetPrivilege == null ? null : EnumSet.of(targetPrivilege), privilegesOnSecondary);
  }
  ...
  /** RBAC admin operation with single privilege on target entities. */
  PolarisAuthorizableOperation(boolean rbacAdminOperation, PolarisPrivilege targetPrivilege) {
    this(rbacAdminOperation, targetPrivilege == null ? null : EnumSet.of(targetPrivilege), null);
  }

  /** RBAC admin operation with single privilege on target and secondary. */
  PolarisAuthorizableOperation(
      boolean rbacAdminOperation,
  ...
  PolarisAuthorizableOperation(
    ...
    this.rbacAdminOperation = rbacAdminOperation;

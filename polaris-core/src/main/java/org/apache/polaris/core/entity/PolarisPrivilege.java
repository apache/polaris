...
public enum PolarisPrivilege {
  ...
  SEMANTIC_MODEL_READ_PROPERTIES(105, PolarisEntityType.SEMANTIC_MODEL),
  SEMANTIC_MODEL_WRITE_PROPERTIES(106, PolarisEntityType.SEMANTIC_MODEL),
  ...
  SEMANTIC_MODEL_LIST_GRANTS(109, PolarisEntityType.SEMANTIC_MODEL),
  SEMANTIC_MODEL_MANAGE_GRANTS_ON_SECURABLE(110, PolarisEntityType.SEMANTIC_MODEL),
  ;

...
record RbacOperationSemantics(
    ...
    PathEvaluationScope targetScope,
    PathEvaluationScope secondaryScope) {
  ...
  private RbacOperationSemantics(
      ...
      PathEvaluationScope targetScope,
      PathEvaluationScope secondaryScope) {
    this(toEnumSet(targetPrivileges), toEnumSet(secondaryPrivileges), targetScope, secondaryScope);
  }

  public RbacOperationSemantics {
    Preconditions.checkNotNull(targetPrivileges, "targetPrivileges");
    Preconditions.checkNotNull(targetScope, "targetScope");
    secondaryPrivileges =
    ...
    if (!secondaryPrivileges.isEmpty()) {
      Preconditions.checkNotNull(
          secondaryScope, "secondaryScope must be non-null when secondaryPrivileges are present");
    }
  }

  enum PathEvaluationScope {
    ROOT,
    CATALOG
  }
  ...
  static {
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RbacOperationSemantics(List.of(NAMESPACE_LIST), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.CREATE_NAMESPACE,
        new RbacOperationSemantics(
            List.of(NAMESPACE_CREATE), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.LOAD_NAMESPACE_METADATA,
        new RbacOperationSemantics(
            List.of(NAMESPACE_READ_PROPERTIES), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.NAMESPACE_EXISTS,
        new RbacOperationSemantics(List.of(NAMESPACE_LIST), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.DROP_NAMESPACE,
        new RbacOperationSemantics(List.of(NAMESPACE_DROP), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.UPDATE_NAMESPACE_PROPERTIES,
        new RbacOperationSemantics(
            List.of(NAMESPACE_WRITE_PROPERTIES), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.LIST_TABLES,
        new RbacOperationSemantics(List.of(TABLE_LIST), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.CREATE_TABLE_DIRECT,
        new RbacOperationSemantics(List.of(TABLE_CREATE), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.CREATE_TABLE_DIRECT_WITH_WRITE_DELEGATION,
        new RbacOperationSemantics(
            List.of(TABLE_CREATE, TABLE_WRITE_DATA), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RbacOperationSemantics(
            List.of(TABLE_READ_PROPERTIES), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.LOAD_TABLE_WITH_READ_DELEGATION,
        new RbacOperationSemantics(List.of(TABLE_READ_DATA), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.LOAD_TABLE_WITH_WRITE_DELEGATION,
        new RbacOperationSemantics(
            List.of(TABLE_WRITE_DATA), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.UPDATE_TABLE,
        new RbacOperationSemantics(
            List.of(TABLE_WRITE_PROPERTIES), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.UPDATE_TABLE_FOR_STAGED_CREATE,
        new RbacOperationSemantics(List.of(TABLE_CREATE), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.DROP_TABLE_WITHOUT_PURGE,
        new RbacOperationSemantics(List.of(TABLE_DROP), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.DROP_TABLE_WITH_PURGE,
        new RbacOperationSemantics(
            List.of(TABLE_DROP, TABLE_WRITE_DATA), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RbacOperationSemantics(
            List.of(TABLE_DROP),
            List.of(TABLE_LIST, TABLE_CREATE),
            PathEvaluationScope.ROOT,
            PathEvaluationScope.ROOT));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.COMMIT_TRANSACTION,
        new RbacOperationSemantics(
            List.of(TABLE_WRITE_PROPERTIES, TABLE_CREATE), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.LIST_VIEWS,
        new RbacOperationSemantics(List.of(VIEW_LIST), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.CREATE_VIEW,
        new RbacOperationSemantics(List.of(VIEW_CREATE), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.LOAD_VIEW,
        new RbacOperationSemantics(
            List.of(VIEW_READ_PROPERTIES), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.REPLACE_VIEW,
        new RbacOperationSemantics(
            List.of(VIEW_WRITE_PROPERTIES), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.DROP_VIEW,
        new RbacOperationSemantics(List.of(VIEW_DROP), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RbacOperationSemantics(List.of(CATALOG_LIST), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.CREATE_CATALOG,
        new RbacOperationSemantics(List.of(CATALOG_CREATE), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.GET_CATALOG,
        new RbacOperationSemantics(
            List.of(CATALOG_READ_PROPERTIES), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.UPDATE_CATALOG,
        new RbacOperationSemantics(
            List.of(CATALOG_WRITE_PROPERTIES), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.DELETE_CATALOG,
        new RbacOperationSemantics(List.of(CATALOG_DROP), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.LIST_PRINCIPALS,
        new RbacOperationSemantics(List.of(PRINCIPAL_LIST), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.CREATE_PRINCIPAL,
        new RbacOperationSemantics(
            List.of(PRINCIPAL_CREATE), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.GET_PRINCIPAL,
        new RbacOperationSemantics(
            List.of(PRINCIPAL_READ_PROPERTIES), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.UPDATE_PRINCIPAL,
        new RbacOperationSemantics(
            List.of(PRINCIPAL_WRITE_PROPERTIES), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.DELETE_PRINCIPAL,
        new RbacOperationSemantics(List.of(PRINCIPAL_DROP), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.ROTATE_CREDENTIALS,
        new RbacOperationSemantics(
            List.of(PRINCIPAL_ROTATE_CREDENTIALS), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.RESET_CREDENTIALS,
        new RbacOperationSemantics(
            List.of(PRINCIPAL_RESET_CREDENTIALS), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.LIST_PRINCIPAL_ROLES_ASSIGNED,
        new RbacOperationSemantics(
            List.of(PRINCIPAL_LIST_GRANTS), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RbacOperationSemantics(
            List.of(PRINCIPAL_ROLE_LIST), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.CREATE_PRINCIPAL_ROLE,
        new RbacOperationSemantics(
            List.of(PRINCIPAL_ROLE_CREATE), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.GET_PRINCIPAL_ROLE,
        new RbacOperationSemantics(
            List.of(PRINCIPAL_ROLE_READ_PROPERTIES), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.UPDATE_PRINCIPAL_ROLE,
        new RbacOperationSemantics(
            List.of(PRINCIPAL_ROLE_WRITE_PROPERTIES), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.DELETE_PRINCIPAL_ROLE,
        new RbacOperationSemantics(
            List.of(PRINCIPAL_ROLE_DROP), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.LIST_ASSIGNEE_PRINCIPALS_FOR_PRINCIPAL_ROLE,
        new RbacOperationSemantics(
            List.of(PRINCIPAL_ROLE_LIST_GRANTS), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RbacOperationSemantics(
            List.of(CATALOG_ROLE_LIST), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.CREATE_CATALOG_ROLE,
        new RbacOperationSemantics(
            List.of(CATALOG_ROLE_CREATE), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.GET_CATALOG_ROLE,
        new RbacOperationSemantics(
            List.of(CATALOG_ROLE_READ_PROPERTIES), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.UPDATE_CATALOG_ROLE,
        new RbacOperationSemantics(
            List.of(CATALOG_ROLE_WRITE_PROPERTIES), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.DELETE_CATALOG_ROLE,
        new RbacOperationSemantics(
            List.of(CATALOG_ROLE_DROP), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.LIST_ASSIGNEE_PRINCIPAL_ROLES_FOR_CATALOG_ROLE,
        new RbacOperationSemantics(
            List.of(CATALOG_ROLE_LIST_GRANTS), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RbacOperationSemantics(
            List.of(SERVICE_MANAGE_ACCESS), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RbacOperationSemantics(
            List.of(PRINCIPAL_MANAGE_GRANTS_ON_SECURABLE), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RbacOperationSemantics(
            List.of(CATALOG_MANAGE_GRANTS_ON_SECURABLE), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RbacOperationSemantics(
            List.of(CATALOG_LIST_GRANTS), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.ADD_NAMESPACE_GRANT_TO_CATALOG_ROLE,
        new RbacOperationSemantics(
            List.of(NAMESPACE_MANAGE_GRANTS_ON_SECURABLE), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RbacOperationSemantics(
            List.of(NAMESPACE_LIST_GRANTS), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.ADD_TABLE_GRANT_TO_CATALOG_ROLE,
        new RbacOperationSemantics(
            List.of(TABLE_MANAGE_GRANTS_ON_SECURABLE), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RbacOperationSemantics(
            List.of(TABLE_LIST_GRANTS), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.ADD_VIEW_GRANT_TO_CATALOG_ROLE,
        new RbacOperationSemantics(
            List.of(VIEW_MANAGE_GRANTS_ON_SECURABLE), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RbacOperationSemantics(
            List.of(VIEW_LIST_GRANTS), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.CREATE_POLICY,
        new RbacOperationSemantics(List.of(POLICY_CREATE), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.LOAD_POLICY,
        new RbacOperationSemantics(List.of(POLICY_READ), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.DROP_POLICY,
        new RbacOperationSemantics(List.of(POLICY_DROP), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.UPDATE_POLICY,
        new RbacOperationSemantics(List.of(POLICY_WRITE), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.LIST_POLICY,
        new RbacOperationSemantics(List.of(POLICY_LIST), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.ATTACH_POLICY_TO_CATALOG,
        new RbacOperationSemantics(
            List.of(POLICY_ATTACH),
            List.of(CATALOG_ATTACH_POLICY),
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RbacOperationSemantics(
            List.of(POLICY_ATTACH),
            List.of(NAMESPACE_ATTACH_POLICY),
            PathEvaluationScope.CATALOG,
            PathEvaluationScope.CATALOG));
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RbacOperationSemantics(
            List.of(POLICY_ATTACH),
            List.of(TABLE_ATTACH_POLICY),
            PathEvaluationScope.CATALOG,
            PathEvaluationScope.CATALOG));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.DETACH_POLICY_FROM_CATALOG,
        new RbacOperationSemantics(
            List.of(POLICY_DETACH),
            List.of(CATALOG_DETACH_POLICY),
            PathEvaluationScope.CATALOG,
            PathEvaluationScope.CATALOG));
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RbacOperationSemantics(
            List.of(POLICY_DETACH),
            List.of(NAMESPACE_DETACH_POLICY),
            PathEvaluationScope.CATALOG,
            PathEvaluationScope.CATALOG));
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RbacOperationSemantics(
            List.of(POLICY_DETACH),
            List.of(TABLE_DETACH_POLICY),
            PathEvaluationScope.CATALOG,
            PathEvaluationScope.CATALOG));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.GET_APPLICABLE_POLICIES_ON_CATALOG,
        new RbacOperationSemantics(
            List.of(CATALOG_READ_PROPERTIES), null, PathEvaluationScope.CATALOG, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RbacOperationSemantics(
            List.of(POLICY_MANAGE_GRANTS_ON_SECURABLE), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
    ...
    RBAC_SEMANTICS_BY_OPERATION.put(
        ...
        new RbacOperationSemantics(
            List.of(TABLE_ASSIGN_UUID), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.UPGRADE_TABLE_FORMAT_VERSION,
        new RbacOperationSemantics(
            List.of(TABLE_UPGRADE_FORMAT_VERSION), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.ADD_TABLE_SCHEMA,
        new RbacOperationSemantics(
            List.of(TABLE_ADD_SCHEMA), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.SET_TABLE_CURRENT_SCHEMA,
        new RbacOperationSemantics(
            List.of(TABLE_SET_CURRENT_SCHEMA), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.ADD_TABLE_PARTITION_SPEC,
        new RbacOperationSemantics(
            List.of(TABLE_ADD_PARTITION_SPEC), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.ADD_TABLE_SORT_ORDER,
        new RbacOperationSemantics(
            List.of(TABLE_ADD_SORT_ORDER), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.SET_TABLE_DEFAULT_SORT_ORDER,
        new RbacOperationSemantics(
            List.of(TABLE_SET_DEFAULT_SORT_ORDER), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.ADD_TABLE_SNAPSHOT,
        new RbacOperationSemantics(
            List.of(TABLE_ADD_SNAPSHOT), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.SET_TABLE_SNAPSHOT_REF,
        new RbacOperationSemantics(
            List.of(TABLE_SET_SNAPSHOT_REF), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.REMOVE_TABLE_SNAPSHOTS,
        new RbacOperationSemantics(
            List.of(TABLE_REMOVE_SNAPSHOTS), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.REMOVE_TABLE_SNAPSHOT_REF,
        new RbacOperationSemantics(
            List.of(TABLE_REMOVE_SNAPSHOT_REF), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.SET_TABLE_LOCATION,
        new RbacOperationSemantics(
            List.of(TABLE_SET_LOCATION), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.SET_TABLE_PROPERTIES,
        new RbacOperationSemantics(
            List.of(TABLE_SET_PROPERTIES), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.REMOVE_TABLE_PROPERTIES,
        new RbacOperationSemantics(
            List.of(TABLE_REMOVE_PROPERTIES), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.SET_TABLE_STATISTICS,
        new RbacOperationSemantics(
            List.of(TABLE_SET_STATISTICS), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.REMOVE_TABLE_STATISTICS,
        new RbacOperationSemantics(
            List.of(TABLE_REMOVE_STATISTICS), null, PathEvaluationScope.ROOT, null));
    RBAC_SEMANTICS_BY_OPERATION.put(
        PolarisAuthorizableOperation.REMOVE_TABLE_PARTITION_SPECS,
        new RbacOperationSemantics(
            List.of(TABLE_REMOVE_PARTITION_SPECS), null, PathEvaluationScope.ROOT, null));

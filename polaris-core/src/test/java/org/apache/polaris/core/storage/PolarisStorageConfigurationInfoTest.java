    ...
    return Stream.of(
        arguments(
            AwsStorageConfigurationInfo.builder()
                ...
                .region("no-where-1")
                .build(),
            "{\"@type\":\"AwsStorageConfigurationInfo\",\"storageType\":\"S3\",\"credentialVendingMechanism\":\"STS\",\"allowedLocations\":[\"s3://foo/bar\",\"s3://no/where\"],\"roleARN\":\"arn:aws:iam::123456789012:role/polaris-test\",\"region\":\"no-where-1\",\"fileIoImplClassName\":\"org.apache.iceberg.aws.s3.S3FileIO\"}"),
        arguments(
            AwsStorageConfigurationInfo.builder()
                .addAllowedLocations("s3://foo/bar", "s3://no/where")
                .region("no-where-1")
                ...
                .build(),
            "{\"@type\":\"AwsStorageConfigurationInfo\",\"storageType\":\"S3\",\"credentialVendingMechanism\":\"STS\",\"allowedLocations\":[\"s3://foo/bar\",\"s3://no/where\"],\"roleARN\":\"arn:aws:iam::123456789012:role/polaris-test\",\"externalId\":\"external-id\",\"region\":\"no-where-1\",\"fileIoImplClassName\":\"org.apache.iceberg.aws.s3.S3FileIO\"}"),
        arguments(
            AwsStorageConfigurationInfo.builder()
                .addAllowedLocations("s3://foo/bar", "s3://no/where")
                .region("no-where-1")

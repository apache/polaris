...
class AwsCredentialsStorageIntegrationTest {
  ...
  public void testGetSubscopedCreds() {
    ...
    assertThat(credentials)
        .isNotEmpty()
        .containsEntry(IcebergStorageAccessProperty.AWS_TOKEN, "sess")
        .containsEntry(IcebergStorageAccessProperty.AWS_KEY_ID, "accessKey")
        .containsEntry(IcebergStorageAccessProperty.AWS_SECRET_KEY, "secretKey")
        .containsEntry(
  ...
  public void testClientRegion(String awsPartition) {
    ...
    switch (awsPartition) {
      ...
      case "aws-us-gov":
        ...
        assertThat(credentials)
            .isNotEmpty()
            .containsEntry(IcebergStorageAccessProperty.CLIENT_REGION, clientRegion);
        break;
      default:
        throw new IllegalArgumentException("Unknown aws partition: " + awsPartition);
    }
  ...
  public void testNoClientRegion(String awsPartition) {
    ...
    switch (awsPartition) {
      case AWS_PARTITION:
        ...
        assertThat(credentials)
            .isNotEmpty()
            .doesNotContainKey(IcebergStorageAccessProperty.CLIENT_REGION);
        break;
      case "aws-cn":
      case "aws-us-gov":
        Assertions.assertThatThrownBy(

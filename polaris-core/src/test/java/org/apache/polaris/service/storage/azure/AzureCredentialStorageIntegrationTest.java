...
public class AzureCredentialStorageIntegrationTest {
  ...
  public void testNegativeCases() {
    ...
    Assertions.assertThatThrownBy(
            () ->
                subscopedCredsForOperations(
                    realm, differentEndpointList, /* allowedWriteLoc= */ new ArrayList<>(), true))
    ...
    Assertions.assertThatThrownBy(
            () ->
                subscopedCredsForOperations(
                    realm, differentStorageAccts, /* allowedWriteLoc= */ new ArrayList<>(), true))
        .isInstanceOf(RuntimeException.class);
    ...
    Assertions.assertThatThrownBy(
            () ->
                subscopedCredsForOperations(
                    realm, differentContainers, /* allowedWriteLoc= */ new ArrayList<>(), true))
        .isInstanceOf(RuntimeException.class);
  }

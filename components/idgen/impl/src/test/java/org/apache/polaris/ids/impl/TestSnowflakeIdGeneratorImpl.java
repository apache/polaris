...
public class TestSnowflakeIdGeneratorImpl {
    ...
    soft.assertThatCode(
            () ->
                new SnowflakeIdGeneratorFactory()
                    .buildIdGenerator(Map.of(), 0, clock::currentTimeMillis, () -> true))
  ...
  public void invalidArgs() {
    ...
    soft.assertThatNullPointerException()
        .isThrownBy(
            () ->
                new SnowflakeIdGeneratorFactory().buildIdGenerator(Map.of(), 42, null, () -> true))
    ...
    soft.assertThatIllegalArgumentException()
        .isThrownBy(
            () ->
                new SnowflakeIdGeneratorFactory()
                    .buildIdGenerator(Map.of(), -1, () -> 0L, () -> true))
        .withMessage(
    ...
    soft.assertThatIllegalArgumentException()
        .isThrownBy(
            () ->
                new SnowflakeIdGeneratorFactory()
                    .buildIdGenerator(Map.of(), -1, validClock, () -> true))
        .withMessage("nodeId -1 out of range [0..1024[");
    soft.assertThatIllegalArgumentException()
        .isThrownBy(
            () ->
                new SnowflakeIdGeneratorFactory()
                    .buildIdGenerator(Map.of(), 1 << DEFAULT_NODE_ID_BITS, validClock, () -> true))
  ...
  public void clockBackwards() {
    ...
    var impl =
        new SnowflakeIdGeneratorFactory()
            .buildIdGenerator(Map.of(), nodeId, clock::get, () -> true);
  ...
  public void concurrency() throws Exception {
    ...
    var impl =
        new SnowflakeIdGeneratorImpl(nodeId, clock::get, () -> true) {
          @Override
          void holdForTest() {
  ...
  public void manyThreads() throws Exception {
    ...
    var impl =
        new SnowflakeIdGeneratorFactory()
            .buildIdGenerator(Map.of(), nodeId, clock::currentTimeMillis, () -> true);
  ...
  public void maxIdsPerMillisecondAtEpochOffset() {
    ...
    var impl =
        new SnowflakeIdGeneratorImpl(nodeId, clock, () -> true) {
          @Override
  ...
  public void validationCallback() {
    ...
    var impl =
        new SnowflakeIdGeneratorFactory()
            .buildIdGenerator(Map.of(), nodeId, clock::currentTimeMillis, validationValue::get);

...
import org.apache.polaris.authz.api.AclChain;
...
final class PrivilegeCheckImpl implements PrivilegeCheck {

  private final Set<String> roleIds;
  private final Privileges privileges;

  PrivilegeCheckImpl(Set<String> roleIds, Privileges privileges) {

...
public class TestRealmManagementImpl {
  ...
  public void createUpdateDelete() {
    ...
    soft.assertThatIllegalArgumentException()
        .isThrownBy(() -> realmsManagement.create(RealmId.SYSTEM))
        .withMessage("Invalid realm ID");
    soft.assertThatIllegalArgumentException()
        .isThrownBy(() -> realmsManagement.create(newRealmId("::something")))
        .withMessage("Invalid realm ID");
    soft.assertThatIllegalArgumentException()
        .isThrownBy(
            () ->
        ...
        .withMessage("Invalid realm ID");
    soft.assertThatIllegalArgumentException()
        .isThrownBy(() -> realmsManagement.delete(something.withId(newRealmId("::something"))))
        .withMessage("Invalid realm ID");
    ...
    soft.assertThatThrownBy(
            () -> realmsManagement.delete(something.withId(newRealmId("foo")).withStatus(PURGED)))
        .isInstanceOf(RealmNotFoundException.class)
        .hasMessage("No realm with ID 'foo' exists");

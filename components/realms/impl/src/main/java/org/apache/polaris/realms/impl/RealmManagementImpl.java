...
class RealmManagementImpl implements RealmManagement {
  ...
  @Override
  @Nonnull
  public Optional<RealmDefinition> get(@Nonnull RealmId realmId) {
    checkArgument(!realmId.id().startsWith("::"), "Invalid realm ID");
  ...
  @Override
  @Nonnull
  public RealmDefinition create(@Nonnull RealmId realmId) {
    checkArgument(!realmId.id().startsWith("::"), "Invalid realm ID");
  ...
  public RealmDefinition update(
    ...
    checkArgument(!expected.id().id().startsWith("::"), "Invalid realm ID");

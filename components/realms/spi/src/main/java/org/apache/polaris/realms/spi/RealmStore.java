...
public interface RealmStore {
  ...
  Optional<RealmDefinition> get(RealmId realmId);
   ...
   */
  void delete(RealmId realmId, Consumer<RealmDefinition> callback);
   ...
   * @throws RealmNotFoundException if a realm with the given ID does not exist
   */
  RealmDefinition update(RealmId realmId, Function<RealmDefinition, RealmDefinition> updater);
   ...
   */
  RealmDefinition create(RealmId realmId, RealmDefinition definition);
}

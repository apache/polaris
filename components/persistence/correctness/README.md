...
# Polaris Persistence Correctness Tests

Collection of tests that use JUnit to verify correctness of the persistence implementation.

`:polaris-persistence-correctness` contains a couple of test suites with test tasks named `correctnessTest-XYZ`,

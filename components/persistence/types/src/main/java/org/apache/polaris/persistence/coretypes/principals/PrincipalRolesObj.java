 ...
 * under the License.
 */
package org.apache.polaris.persistence.coretypes.principals;
...
/**
 * Maintains the mapping of all principals roles to {@link PrincipalRoleObj}s. The current version
 * of this object is maintained via the reference {@value #PRINCIPAL_ROLES_REF_NAME}.
 */
@PolarisImmutable

...
import org.apache.polaris.persistence.api.obj.AnotherTestObj;
import org.apache.polaris.persistence.api.obj.ImmutableVersionedTestObj;
import org.apache.polaris.persistence.api.obj.Obj;
import org.apache.polaris.persistence.api.obj.ObjRef;
import org.apache.polaris.persistence.api.obj.SimpleTestObj;
import org.apache.polaris.persistence.api.obj.VersionedTestObj;
...
public abstract class AbstractPersistenceTests {
  ...
  public void referenceRecentPointers(TestInfo testInfo) {
    ...
    var recentPointers = new LinkedList<Long>();
  ...
  public void objs() {
    ...
    soft.assertThatIllegalArgumentException()
        ...
        .withMessageStartingWith(
            "Mismatch between persisted object type 'test-simple' (interface org.apache.polaris.persistence.api.obj.SimpleTestObj) and deserialized interface org.apache.polaris.persistence.api.obj.AnotherTestObj.");
    soft.assertThatIllegalArgumentException()
        .isThrownBy(
            () ->
                persistence()
  ...
  public void hugeObject(int binaryLen) {
    ...
    // Fetch with "wrong" number of parts
  ...
  public void backendScan(
    ...
    var realmRefs = new HashMap<RealmId, List<String>>();
    var realmObjs = new HashMap<RealmId, List<ObjRef>>();
    backend.scanBackend(

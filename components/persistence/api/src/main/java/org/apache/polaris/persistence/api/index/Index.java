...
/**
 * General interface for all store indexes, indexes <em>are generally <b>not thread-safe</b></em>
 * when modified, read-only accesses are thread-safe.
 *
 * @param <V> value type
 */
public interface Index<V> extends Iterable<Map.Entry<IndexKey, V>> {
  ...
  /**
   * Reverse iterate over the elements in this index, with optional lower/higher or prefix
   * restrictions.
   *

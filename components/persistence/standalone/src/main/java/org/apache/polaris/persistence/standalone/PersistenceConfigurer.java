 ...
 * under the License.
 */
package org.apache.polaris.persistence.standalone;
            ...
            .orElseThrow(
                () ->
                    new IllegalArgumentException(
                        "No backend name provided, for example via the system property 'polaris.backend.name', available backend names: "

 ...
 * under the License.
 */
package org.apache.polaris.persistence.testextension;

import static com.google.common.base.Preconditions.checkState;
import static org.apache.polaris.persistence.testextension.PolarisPersistence.RANDOM_REALM;
...
import org.apache.polaris.persistence.api.commit.FairRetriesType;
import org.apache.polaris.persistence.api.commit.RetryConfig;
import org.apache.polaris.persistence.cache.CacheConfig;
import org.apache.polaris.persistence.cache.CacheSizing;
import org.apache.polaris.persistence.cache.PersistenceCaches;
...
public class PersistenceTestExtension
        ...
        x ->
            new SnowflakeIdGeneratorFactory()
                .buildIdGenerator(
                    ...
                    123,
                    () ->
                        getOrCreateMonotonicClock(extensionContext).currentTimeMillis()
                            // TODO remove this "+ 60 days" !!
  ...
  private Backend getOrCreateBackend(ExtensionContext extensionContext, BackendSpec backendSpec) {
    ...
    try {
      ...
      LOGGER.info("Opened new persistence backend '{}' {}", instance.name(), info);
  ...
  private Persistence createPersistence(
    ...
    var uncachedPersistence =
        backend.newPersistence(persistenceConfig.build(), realmId, clock, idGenerator);
  ...
  static final class WrappedResource implements ExtensionContext.Store.CloseableResource {

...
@ApplicationScoped
@SystemPersistence
public class ObservingSystemPersistence extends ObservingPersistence {
  private final Persistence delegate;

  @Inject
  ObservingSystemPersistence(
      Backend backend,
    ...
    var persistence =
        backend.newPersistence(persistenceParams, RealmId.SYSTEM, monotonicClock, idGenerator);

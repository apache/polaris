...
description = "Polaris persistence, providers for CDI/Weld."
...
dependencies {
  ...
  testFixturesApi(project(":polaris-realms-id"))
  testFixturesApi(platform(libs.jackson.bom))
  testFixturesApi("com.fasterxml.jackson.dataformat:jackson-dataformat-smile")
  testFixturesApi(project(":polaris-persistence-inmemory"))
  testFixturesApi(testFixtures(project(":polaris-persistence-inmemory")))
  testFixturesImplementation(project(":polaris-persistence-cache"))
  testFixturesImplementation(project(":polaris-persistence-cdi-common"))
  testFixturesImplementation(project(":polaris-persistence-commits"))

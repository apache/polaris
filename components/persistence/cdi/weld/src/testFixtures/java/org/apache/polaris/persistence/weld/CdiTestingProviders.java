...
import org.apache.polaris.persistence.inmemory.InMemoryConfiguration;
...
public class CdiTestingProviders {
  ...
  BackendConfiguration backendConfiguration() {
    return BackendConfiguration.BuildableBackendConfiguration.builder().name("InMemory").build();
  }

...
description = "Polaris persistence bridge to meta-store"
...
dependencies {
  ...
  testRuntimeOnly(project(":polaris-authz-store"))
  testRuntimeOnly(project(":polaris-service-common"))
  testRuntimeOnly(testFixtures(project(":polaris-persistence-cdi-weld")))
  testImplementation(testFixtures(project(":polaris-persistence-types")))

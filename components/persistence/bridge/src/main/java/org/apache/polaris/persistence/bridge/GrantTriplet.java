...
record GrantTriplet(boolean securable, long catalogId, long id, int typeCode) {
  ...
  static GrantTriplet forEntity(boolean securable, PolarisEntityCore entity) {
    return new GrantTriplet(securable, entity.getCatalogId(), entity.getId(), entity.getTypeCode());
  }

  String toRoleName() {
    return (securable ? "r/" : "d/") + catalogId + "/" + id + "/" + typeCode;
  }
}

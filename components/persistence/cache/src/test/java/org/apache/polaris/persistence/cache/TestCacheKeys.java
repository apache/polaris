...
import static org.apache.polaris.persistence.cache.CaffeineCacheBackend.cacheKeyObjId;
import static org.apache.polaris.persistence.cache.CaffeineCacheBackend.cacheKeyValueNegative;
import static org.apache.polaris.persistence.cache.CaffeineCacheBackend.cacheKeyValueObj;
import static org.apache.polaris.persistence.cache.CaffeineCacheBackend.cacheKeyValueObjRead;
import static org.apache.polaris.persistence.cache.CaffeineCacheBackend.cacheKeyValueReference;
import static org.apache.polaris.persistence.cache.CaffeineCacheBackend.cacheKeyValueReferenceRead;
import static org.apache.polaris.realms.id.RealmId.newRealmId;
import static org.junit.jupiter.params.provider.Arguments.arguments;

import java.util.stream.Stream;
import org.apache.polaris.persistence.api.obj.ImmutableGenericObj;
...
public class TestCacheKeys {
  ...
  @ParameterizedTest
  @MethodSource
  public void referenceKeys(RealmId realmId, String referenceName) {
    ...
    var readDiffRealm = cacheKeyValueReferenceRead(RealmId.SYSTEM, referenceName);
  ...
  static Stream<Arguments> referenceKeys() {
    return Stream.of(
        arguments(newRealmId("realm"), ""),
        arguments(newRealmId("realm"), "ref"),
        arguments(newRealmId(""), "ref"),
        arguments(newRealmId(""), ""));
  }

  @ParameterizedTest
  @MethodSource
  public void objKeys(RealmId realmId, String type, long id) {
  ...
  static Stream<Arguments> objKeys() {
    return Stream.of(
        arguments(newRealmId("realm"), "type1", 42L), arguments(newRealmId(""), "x", 43L));
  }
}
